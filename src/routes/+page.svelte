	...
	<div class="row container" style="margin-top:100px;padding-bottom:216px; width: 1116px;">
		<div class="col-7 col-md-7 col-sm-12">
			<div class="row">
				...
				<h1 class="fancy-text" style="font-size: 48px;line-height:64px; font-weight:700;">
					{attributes.homepage_top_title}
				</h1>
			</div>
			...
			<div class="row" style="margin-top: 80px;">
				<div class="col-3 video-row">
					<a href="https://www.google.com"
						><img
							src={'https://triple-a.io/wp-content/uploads/2023/09/logo-nobackground-5000-1-1.svg'}
							alt="brnad1"
						/></a
					>
				</div>
				<div class="col-3 video-row">
					<a href="https://www.google.com"
						><img
							src={'https://triple-a.io/wp-content/uploads/2023/07/image-15.svg'}
							alt="brnad1"
						/></a
					>
				</div>
				<div class="col-3 video-row">
					<a href="https://www.google.com"
						><img
							src={'https://triple-a.io/wp-content/uploads/2023/07/image-16.svg'}
							alt="brnad1"
						/></a
					>
				</div>
				<div class="col-3 video-row">
					<a href="https://www.google.com"
						><img
							src={'https://triple-a.io/wp-content/uploads/2023/07/image-17.svg'}
							alt="brnad1"
						/></a
					>
				</div>
...
<div
	class="container-fluid second-section"
	style="display: flex;
    flex-direction: row;
    justify-content: center;"
>
	<div class="container" style="width: 1116px;">
		<div class="row second-space" style="height: 300px;">&nbsp;</div>
		<div class="row" style="justify-content: center;">
            ...
            "
			>
				420 million people worldwide want you to offer
			</h1>
		</div>
		<div class="row" style="margin-top: 60px; margin-bottom:100px">
			<ul class="nav nav-tabs" id="myTab" role="tablist" style="margin-bottom: 60px;">
				<li class="nav-item" role="presentation">
					<button
						...
						role="tab"
						aria-controls="home"
						aria-selected="true">Crypto Payments</button
					>
				</li>
				<li class="nav-item" role="presentation">
					<button
						...
						aria-selected="false">Crypto Payouts</button
					>
				</li>
			</ul>
				...
				<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
					<div class="row">
						...
						>
							<div
								class="row"
								style="margin-bottom:30px;color:#FFF;  font-size:18px;line-height:26px;"
							>
								<p>
									Accept payments from a new audience of 420 million crypto owners without holding
									and converting crypto.
								</p>
							</div>
							<div
								class="row"
							...
							>
								<p>
									Accept payments from a new audience of 420 million crypto owners without holding
									and converting crypto. Enjoy lower transaction fees, faster settlements and no
									chargebacks!
								</p>
							</div>
							<div class="row">
			...
			>
				<div class="col-2 video-row">
					<a href="https://www.google.com"
						><img
							src={'https://triple-a.io/wp-content/uploads/2023/08/62b0c3d62951158751131e7e_1.svg.svg'}
							alt="brnad1"
						/></a
					>
				</div>
				<div class="col-3 video-row">
					<a href="https://www.google.com"
						><img
							src={'https://triple-a.io/wp-content/uploads/2023/08/62b0c3d79103d607ae28ea89_bookingcom-logo-svgrepo-com201.svg.svg'}
							alt="brnad1"
						/></a
					>
				</div>
				<div class="col-2 video-row">
					<a href="https://www.google.com"
						><img
							src={'https://triple-a.io/wp-content/uploads/2023/08/Frame-2610802.svg'}
							alt="brnad1"
						/></a
					>
				</div>
				<div class="col-2 video-row">
					<a href="https://www.google.com"
						><img
							src={'https://triple-a.io/wp-content/uploads/2023/08/Frame-2610799.svg'}
							alt="brnad1"
						/></a
					>
				</div>
				<div class="col-2 video-row">
					<a href="https://www.google.com"
						><img
							src={'https://triple-a.io/wp-content/uploads/2023/07/razer-1-1.svg'}
							alt="brnad1"
						/></a
					>
				</div>
			...
			>
				<div class="col-2 video-row">
					<a href="https://www.google.com"
						><img
							src={'https://triple-a.io/wp-content/uploads/2023/10/istudio_logo.png'}
							alt="brnad1"
						/></a
					>
				</div>
				<div class="col-2 video-row">
					<a href="https://www.google.com"
						><img
							src={'https://triple-a.io/wp-content/uploads/2023/08/Frame-2610798.svg'}
							alt="brnad1"
						/></a
					>
				</div>
				<div class="col-2 video-row">
					<a href="https://www.google.com"
						><img
							src={'https://triple-a.io/wp-content/uploads/2023/08/Frame-2610800.svg'}
							alt="brnad1"
						/></a
					>
				</div>
				<div class="col-2 video-row">
					<a href="https://www.google.com"
						><img
							src={'https://triple-a.io/wp-content/uploads/2023/08/628c0242eac3cc8248526caa_Asset-24-1-1.svg'}
							alt="brnad1"
						/></a
					>
				</div>
		...
		<div class="row">
			<div class="col-6">
				<div class="row">
					<div class="col-6">
						<h2 style="color: #FFF; font-size:32px;margin-top:60px;margin-bottom:90px;">
							Accept crypto, receive funds in USD the next day.
						</h2>
			...
			<div class="col-6">
				<img
					class="width100"
					src={'https://triple-a.io/wp-content/uploads/2023/08/Frame-70.png'}
					alt="crypto payments"
				/>
			</div>
		</div>
...
<div
	class="row third-section container-fluid"
	style="display: flex;
    flex-direction: row;
	...
	<div class="container" style="width: 1116px;">
		...
		<div class="row">
			...
			>
				<img
					class="width100"
					src={'https://triple-a.io/wp-content/uploads/2023/08/Group-130-min.png'}
					alt="crypto payments"
				/>
			</div>
			<div class="col-6">
				<div class="row" style="margin-bottom: 90px;">
					<h1 style="font-size: 32px;">Pay anyone, anywhere with crypto.</h1>
				</div>
				<div class="row">
					<div class="col-4">
...
<div
	class="row fourth-section container-fluid"
	style="display: flex;
    flex-direction: row;
...
>
	<div
		class="container"
		style="width: 1116px;display: flex;
        flex-direction: column;
        align-items: center;"
	>
		...
		<div
            ...
            width: 700px;"
		>
			<h3 style="color:#FFF; width:fit-content">I am</h3>
			<button> an E-Commerce</button>
...
<div
	class="row fift-section container-fluid"
	style="display: flex;
    flex-direction: row;
    justify-content: center;
    padding-top: 150px;
...
>
	...
	>
		<div class="row" style="margin-bottom:60px;">
			<h1 style="color:#161141; font-size:64px; line-height:79px;text-align: center;">
				Join over 20,000 businesses enjoying the benefits of digital currency payments with
				Triple-A.​
			</h1>
		</div>
		<div
		...
		>
			<div class="col-3">
				<button
					style="color:#161141 !important; background-color:#FFF; border: 1px solid #7E7E7E !important;"
					type="button"
					class="secondary-btn btn-pm">Get in touch</button
				>
			</div>
			<div class="col-3">
